    ...
    try {
      ...
      function openDetailsModalContent(p) {
        ...
        if (p.lat && p.lng) {
          ...
          kontaktDirectionsBtn = '<a href="' + dirUrl + '" target="_blank" rel="noopener" style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;width:100%;height:100%;min-height:64px;background:linear-gradient(135deg,#1a73e8,#0d47a1);color:#fff;border-radius:8px;text-decoration:none;font-size:13px;font-weight:700;text-align:center;box-sizing:border-box;padding:8px;transition:opacity 0.2s" onmouseover="this.style.opacity=\'0.85\'" onmouseout="this.style.opacity=\'1\'">' +
        ...
        if (kontaktBoxHtml && kontaktDirectionsBtn) {
          ...
          // No contacts but clear location – square button on the left
          kontaktInfo = '<div style="margin:12px 0;display:flex"><div style="width:90px;height:90px;flex:0 0 90px">' + kontaktDirectionsBtn + '</div></div>';
        }
