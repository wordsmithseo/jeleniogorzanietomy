            ...
            cluster = L.markerClusterGroup({
              ...
              iconCreateFunction: function(clusterGroup) {
                ...
                if (sponsored > 0) {
                  ...
                  html += '<div class="jg-cluster-circle" style="width:10px;height:10px;border-radius:50%;background:#f59e0b;margin:0 auto 2px"></div>';
                ...
                if (hasBottom) {
                  ...
                  if (places > 0) {
                    ...
                    html += '<div class="jg-cluster-circle" style="width:10px;height:10px;border-radius:50%;background:#16a34a;margin:0 auto 2px"></div>';
                  ...
                  if (curiosities > 0) {
                    ...
                    html += '<div class="jg-cluster-circle" style="width:10px;height:10px;border-radius:50%;background:#2563eb;margin:0 auto 2px"></div>';
                  ...
                  if (events > 0) {
                    ...
                    html += '<div class="jg-cluster-circle" style="width:10px;height:10px;border-radius:50%;background:#111;margin:0 auto 2px"></div>';
