...
(function($) {
  ...
  var JG_Banner = {
    ...
    hideBanner: function() {
      ...
      var ctaHtml = '<a href="/reklama" style="display:flex !important;align-items:center;justify-content:center;gap:12px;width:100%;min-height:90px;padding:12px 24px;box-sizing:border-box;border:1.5px dashed #d1d5db;border-radius:4px;text-decoration:none;color:#6b7280;font-size:14px;background:repeating-linear-gradient(-45deg,#fafafa,#fafafa 10px,#f3f4f6 10px,#f3f4f6 20px)">' +
